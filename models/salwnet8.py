...
class EDSR(nn.Module):
    ...
    def forward(self, x, scale_factor=None, size=None, mode='test'): 
        ...
        # add pos_enc
        pos_enc = self.pos_enc_sinu_2d(d_model=padded_res.shape[1], height=padded_res.shape[2], width=padded_res.shape[3]).to(x.device)
        padded_res = padded_res + pos_enc
