...
'''
geo v2 -> v3: geometric representation for each reference pixel (4 x 2 to D)
'''
...
class LIIF(nn.Module):
    ...
    def __init__(self, encoder_spec, imnet_spec=None,
        ...
        if self.cell_decode:
            geo_in_dim += 2
        self.geo_encoder = nn.Sequential(nn.Linear(geo_in_dim, q_feat_dim // 4),
                                         nn.ReLU(True),
                                         nn.Linear(q_feat_dim // 4, q_feat_dim // 4))
