...
class EDSR(nn.Module):
    ...
    def forward(self, x, scale_factor=None, size=None, mode='test'): 
        ...
        # add pos_enc
        padded_x = padded_x + self.pos_enc_sinu_2d(d_model=self.n_feats, height=H_padded, width=W_padded).to(x.device)
