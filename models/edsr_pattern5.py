...
class EDSR(nn.Module):
    def __init__(self, args, conv=default_conv):
        ...
        if args.no_upsampling:
            ...
            self.tail = nn.Sequential(nn.Conv2d(n_feats + n_patterns, n_feats, 3, 1, 1),
...
@register('edsr-baseline-pattern5')
