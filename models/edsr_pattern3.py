...
"""
v3 : same depth and size of decoder as liif
"""
...
class EDSR(nn.Module):
    def __init__(self, args, conv=default_conv):
        ...
        if args.no_upsampling:
            ...
            self.tail = nn.Sequential(nn.Conv2d(n_feats + n_patterns, 256, 1),
...
@register('edsr-baseline-pattern3')
