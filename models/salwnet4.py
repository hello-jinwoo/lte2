...
v1 -> v4 : move the salw module to the front of the model so that it is applied to low-res feat
           accordingly, the uws (upscale window size) policy is changed
"""
