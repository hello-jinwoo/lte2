...
class EDSR(nn.Module):
    def __init__(self, args, conv=default_conv):
        ...
        if args.no_upsampling:
            ...
            self.tail = nn.Sequential(nn.Conv2d(n_feats, 256, 1),
                                      ...
                                      nn.Conv2d(256, 256, 1),
                                      nn.ReLU(inplace=True), 
                                      nn.Conv2d(256, self.out_dim, 3, 1, 1))
...
@register('edsr-baseline-mlp-dec')
