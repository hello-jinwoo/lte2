...
class EDSR(nn.Module):
    def __init__(self, args, conv=default_conv):
        ...
        self.conv1x1 = nn.Sequential(nn.Conv2d(n_feats + args.slot_dim, n_feats, 1),
